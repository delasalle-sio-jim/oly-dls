...
$par_nb_point = (empty($this->request['nb_point'])) ? "" : $this->request['nb_point'];
...
{	$msg = "Erreur : méthode HTTP incorrecte.";
    ...
    if ($login == "" || $mdp == "" || $par_equipe == "" || $par_jeu == "" || $par_nb_point == "")
    ...
    else
    {
      ...
      {
        $ok = $dao->ajouterUneParticipation($par_jeu, $par_equipe, $par_nb_point);
